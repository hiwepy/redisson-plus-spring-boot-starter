...
**redisson-plus-spring-boot-starter** is a Spring Boot starter that integrates **spring-biz** for applications using spring-biz. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume spring-biz capabilities with minimal setup.
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:redisson-plus-spring-boot-starter:3.4.x.20260527-SNAPSHOT` |
| Config Prefix | `spring.redis` |
...
| Property Binding | ✅ Stable | Binds `spring.redis.*` to `MyRedisProperties` |
...
|---|---|---|:---:|---|:---:|
| `spring.redis.enabled` | boolean | `true` | No | Enable the starter | No |
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `spring.redis.enabled=true` and classpath |
