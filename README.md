...
**Spring Boot Starter for redisson-plus**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/redisson-plus-spring-boot-starter)](https://github.com/easy-4-java/redisson-plus-spring-boot-starter)
...
> **Artifact ID**：`redisson-plus-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**redisson-plus-spring-boot-starter** is a Spring Boot starter that integrates **redisson-plus** for applications using redisson-plus. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume redisson-plus capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using redisson-plus |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for redisson-plus |
| JDK | `17` |
| Coordinates | `io.github.easy4j:redisson-plus-spring-boot-starter:1.0.1-SNAPSHOT` |
| Config Prefix | `redisson.plus` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers redisson-plus beans automatically |
| Property Binding | ✅ Stable | Binds `redisson.plus.*` to `Properties` |
...
|---|---|---|:---:|---|:---:|
| `redisson.plus.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl redisson-plus-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `redisson.plus.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/redisson-plus-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/redisson-plus-spring-boot-starter)
